...
public class GetGeodesicLengthQueryInputValidationTests
{
    ...
    public async Task Uneven_Coordinates_Cause_Exception(params object[] testData)
    {
        ...
        await Assert.ThrowsAsync<InvalidInputException>(() => _instance.GetGeodesicLengthAsync(input));
    }
}
